  ...
  return (
    <>
      ...
      >
        ...
        <img src={src} alt={`${board} board`} loading="lazy" className="h-14 w-20 bg-white object-contain" />
      </button>
      {enlarged && (
        <div
          role="dialog"
  ...
  return (
    <>
      ...
      <p className="mx-auto max-w-7xl px-4 pb-10 text-sm text-slate-500 sm:px-6">
        For board repair requirements, refer to the contact details on the{" "}
        <Link href="/contact" className="font-semibold text-steel-600 hover:underline">
          Contact page
        </Link>
        .
      </p>
