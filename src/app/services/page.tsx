...
export const metadata: Metadata = {
  title: "Services | CLM Electronics Engineering Services",
  description:
          ...
          >
            <div className="flex flex-col gap-4 lg:flex-row lg:gap-10">
              <div className="lg:w-1/3">
                <p className="text-xs font-bold uppercase tracking-[0.18em] text-engineering-600">
                ...
                {cat.id === "board-repair" && (
                  <Link href="/board-repair" className="mt-3 inline-block text-sm font-semibold text-engineering-600 hover:underline">
              ...
              <ul className="grid flex-1 gap-2 sm:grid-cols-2" aria-label={`${cat.title} items`}>
                {cat.items.map((item) => (
                  ...
                  >
                    <span aria-hidden="true" className="mt-0.5 font-bold text-engineering-600">✓</span>
                    {item}
                  </li>
                ))}
              </ul>
